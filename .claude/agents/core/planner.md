...
hooks:
  pre: |
    ...
    node_modules/.bin/ruflo memory store --content "Planner started: $TASK" 2>/dev/null || true

  post: |
    echo "Planning complete"
    node_modules/.bin/ruflo memory store --content "Planner completed: $TASK" 2>/dev/null || true
---
