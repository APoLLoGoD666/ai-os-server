...
// Cost tiers classify query weight so callers can prioritise, batch, or defer.
const COST_TIERS = new Map([
    ['entity',       'fast'],
    ['validate',     'fast'],
    ['migration',    'fast'],
    ['domain',       'fast'],
...
const QueryPlanner = {
    ...
    costOf(intent) {
        ...
        return COST_TIERS.get(ns) || 'medium';
    },
    ...
    plan(intent, params = {}) {
        ...
        const cost       = this.costOf(intent);
        return { intent, params, subsystem, executable, cost };
    },
...
module.exports = { QueryPlanner, NAMESPACE_SUBSYSTEM, COST_TIERS };
