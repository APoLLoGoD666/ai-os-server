...
function _buildGraph() {
    ...
    for (const e of allEdges) {
        ...
        const edge = { to: e.to, from: e.from, type: e.type, label: e.label || '', confidence: e.confidence || 1.0 };
    ...
    return {
        ...
        affected: {
            ...
            direct:          directIds.map(id => {
                ...
                return { id, name: e?.name || null, family: e?.family || null, type: e?.type || null, rel_type: edge?.type || null };
            }),
