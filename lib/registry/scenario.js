...
function _constraintCheck(changes) {
    ...
    // Run constraints with proposed entity state patched in for the duration of the call.
    // engine.withOverrides() merges proposed fields over the live entity and restores on exit.
    const result = engine.withOverrides(changes, () => constraints.check());
