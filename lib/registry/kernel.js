...
// Guarantee domain entities (DOM-*, AGT-*, SVC-*) are always present in the
// engine before any Registry method is called. universe.inject() is idempotent.
try { require('./universe').inject(); } catch (_) {}
