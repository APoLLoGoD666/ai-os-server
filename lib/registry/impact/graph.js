...
// Reactive cache invalidation — no direct coupling to relationship or engine modules.
const { EventBus, EVENTS } = require('../events');
EventBus.on(EVENTS.EDGE_ADDED,      () => GraphCache.invalidate());
EventBus.on(EVENTS.EDGE_REMOVED,    () => GraphCache.invalidate());
EventBus.on(EVENTS.ENTITY_CREATED,  () => { GraphCache._entityIndex = null; });
EventBus.on(EVENTS.ENTITY_UPDATED,  () => { GraphCache._entityIndex = null; });
