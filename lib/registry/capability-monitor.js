 ...
 *   alerts     — capabilities with a status change (fired alert)
 *   suppressed — capabilities that are degraded but unchanged since last check
 *   summary    — { checked, triggered, suppressed }
 */
async function runAlertCheck() {
    ...
    // Record current status for all capabilities (including OPERATIONAL — resets suppression)
