...
const LAYER_PERMISSIONS = {
  0:  { FOUNDER: ['READ','WRITE','DELETE'], COUNCIL: ['READ'],                    SYSTEM: [],                     AGENT: []             },
  5:  { FOUNDER: ['READ','WRITE','DELETE'], COUNCIL: ['READ','WRITE','SUMMARIZE'], SYSTEM: ['READ'],               AGENT: []             },
  10: { FOUNDER: ['READ','WRITE'],          COUNCIL: ['READ','SUMMARIZE'],         SYSTEM: ['READ','WRITE'],       AGENT: ['READ','WRITE'] },
  11: { FOUNDER: ['READ','WRITE','DELETE'], COUNCIL: ['READ','WRITE'],             SYSTEM: ['READ'],               AGENT: ['READ']       },
};
