...
const _DOMAIN_AGENT_IDS = {
    system_agent:   '00000000-0000-4000-8000-00000000000a',
    file_agent:     '00000000-0000-4000-8000-00000000000b',
    uni_agent:      '00000000-0000-4000-8000-00000000000c',
    finance_agent:  '00000000-0000-4000-8000-00000000000d',
    business_agent: '00000000-0000-4000-8000-00000000000e',
};
...
${task.plan || "No plan saved."}`
                ...
                if (directSafeSteps.length) {
                    ...
                    if (!directValidation.fatalError && directValidation.validSteps.length) {
                        ...
                        if (directAutoPlan.executable.length && !directAutoPlan.remaining.length) {
                            ...
                            if (execution.ok) {
                                // V-11-H-B-C: propagate caller identity (handleCommand userId).
        ...
        case "run_agent": {
            ...
            const task = await pgCreateAgentTask(
                ...
                null,
                userId || null,
                _DOMAIN_AGENT_IDS[agentProfile?.id] || null
            );
