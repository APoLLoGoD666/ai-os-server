...
let _getMastraStatus = () => ({ apex: false, email: false, finance: false, routine: false, research: false, mastra: false, details: { status: 'retired — canonical EA is primary' } });
let _initMastra = () => null;
let _mastraAgents = null;
...
module.exports = {
    ...
    getMastraAgents: () => _mastraAgents,
    setMastraAgents: (agents) => { _mastraAgents = agents; },
};
