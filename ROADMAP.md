# Apex AI OS — Feature Roadmap

## Workstream: Communications
- [ ] FEAT-C001: Email reading, summarising, drafting, send & auto-reply
- [ ] FEAT-C002: WhatsApp messages reading, responding via voice prompt
- [ ] FEAT-C003: SMS and iMessage integration
- [ ] FEAT-C004: Additional program monitoring
- [ ] FEAT-C005: Calendar — create, move, cancel, remind
- [ ] FEAT-C006: Contact management — who to follow, who I have not spoken to
- [ ] FEAT-C007: Meeting summaries and action points extracted automatically
- [ ] FEAT-C008: Voicemail transcription
- [ ] FEAT-C009: LinkedIn messages monitored and drafted
- [ ] FEAT-C010: Automated follow-up sequences
- [ ] FEAT-C011: Unsubscribe from junk automatically
- [ ] FEAT-C012: Priority inbox — Apex decides what needs doing today
- [ ] FEAT-C013: Video call scheduling and prep briefs
- [ ] FEAT-C014: Birthday and anniversary reminders with draft messages ready

## Workstream: Finance & Wealth
- [ ] FEAT-F001: Bank account balances on demand
- [ ] FEAT-F002: Transaction categorisation automatically
- [ ] FEAT-F003: Receipt scanning and logging via photo
- [ ] FEAT-F004: Invoice creation and sending
- [ ] FEAT-F005: Payment chasing — automated reminders to clients
- [ ] FEAT-F006: Expense reports generated automatically
- [ ] FEAT-F007: Tax preparation — categorised spending exported
- [ ] FEAT-F008: Crypto portfolio tracking and alerts
- [ ] FEAT-F009: Stock and investment monitoring
- [ ] FEAT-F010: Subscription tracker
- [ ] FEAT-F011: Budget vs actual spending reports
- [ ] FEAT-F012: Cash flow forecasting
- [ ] FEAT-F013: Currency exchange monitoring
- [ ] FEAT-F014: Pension and savings tracking
- [ ] FEAT-F015: Net worth dashboard
- [ ] FEAT-F016: Fraud alert detection on unusual spending
- [ ] FEAT-F017: VAT tracking for self-employed
