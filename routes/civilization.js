...
// Merged from routes/civilisation.js (PWA-02, 2026-07-25): all /civilisation/* routes now served here.
...
// ─── Civilisation Layer (merged from routes/civilisation.js — PWA-02) ─────────
// Auth: inherited from civilization-kernel middleware (resolveIdentity → checkAuthority → checkGovernance)
// Paths intentionally use /civilisation/ prefix (British spelling) — dashboard.html calls these URLs.
